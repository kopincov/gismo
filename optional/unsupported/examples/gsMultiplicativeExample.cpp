/** @file gsMultiplicativeExample.cpp

    @brief Provides an examples for the multigrid solver using a multiplicative Schwarz preconditinoer.
...
)
{
    ...
    gsMultiplicativeOp<real_t>::Ptr result = gsMultiplicativeOp<real_t>::make(matrixCopy.moveToPtr());
