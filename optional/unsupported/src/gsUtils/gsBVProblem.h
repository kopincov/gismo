...
public:
    ...
    typedef typename gsBoundaryConditions<T>::iterator       iterator;
    typedef typename gsBoundaryConditions<T>::const_iterator const_iterator;
...
public:
    ...
    gsBVProblem( gsMultiPatch<T> mp, gsPde<T> * pde ) : m_pde(pde)
    { m_patches.swap(mp); }
