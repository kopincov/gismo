...
struct gsQuasiInterpolate
{
     ...
     */
    static void Taylor(const gsBSplineBasis<T> &b, const gsFunction<T> &fun, const int &r, gsBSpline<T> &result);
     ...
     * @param[out] result   a B-spline function, that approximates the given function
     */
    static void Schoenberg(const gsBSplineBasis<T> &b, const gsFunction<T> &fun, gsBSpline<T> &result);
     ...
     */
    static void EvalBased(const gsBSplineBasis<T> &b, const gsFunction<T> &fun, const bool specialCase, gsBSpline<T> &result);
