...
T igaL2Distance(const gsGeometry<T>& patch, 
                ...
                bool v_isParam)
{
    typename gsGeometryEvaluator<T>::uPtr geoEval(getEvaluator(NEED_VALUE | NEED_MEASURE, patch));
    // assuming real-valued function
    typename gsGeometryEvaluator<T>::uPtr funcEval(getEvaluator(NEED_VALUE, func));
    ...
    //gsVector<index_t> numNodes = gsGaussAssembler<T>::getNumIntNodesFor( func.basis() );
                ...
                bool v_isParam)
{
    ...
    //gsVector<index_t> numNodes = gsGaussAssembler<T>::getNumIntNodesFor( B );
                ...
                bool v_isParam)
{
    ...
    typename gsGeometryEvaluator<T>::uPtr geoEval ( getEvaluator(NEED_VALUE    |
                                                                      NEED_GRAD_TRANSFORM  |
                                                                      NEED_MEASURE, patch ));
    // assuming real-valued function
    typename gsGeometryEvaluator<T>::uPtr funcEval ( getEvaluator(NEED_JACOBIAN, func) );
                                   ...
                                   bool v_isParam)
{
    ...
    typename gsGeometryEvaluator<T>::uPtr geoEval(getEvaluator(NEED_VALUE | NEED_GRAD_TRANSFORM | NEED_MEASURE, patch));
    // assuming real-valued function
    typename gsGeometryEvaluator<T>::uPtr funcEval(getEvaluator(NEED_JACOBIAN, func));
                    ...
                    bool v_isParam)
{
    ...
    typename gsGeometryEvaluator<T>::uPtr geoEval1 ( getEvaluator(NEED_VALUE   |
                                                                        NEED_MEASURE, patch1 ));

    typename gsGeometryEvaluator<T>::uPtr geoEval2 ( getEvaluator(NEED_VALUE   |
                                                                        NEED_MEASURE, patch2 ));
    // assuming real-valued function
