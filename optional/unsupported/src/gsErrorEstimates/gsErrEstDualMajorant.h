...
@brief A class that computes $m^2_d := ||grad v - y||^2_|Omega$, dual part of
       the functional-type error estimator for the Poisson problem.
...
/** \brief Provides computation of dual part of the functional-type element-wise error indicator for the Poisson problem.
*
...
* where the local contributions \f$ \overline{\rm m}^2_{d, K} \f$ on an element \f$ K \f$ are given by
 \f[
...
*
* \ingroup in a style of the files Assembler
*/
    template <class T>
