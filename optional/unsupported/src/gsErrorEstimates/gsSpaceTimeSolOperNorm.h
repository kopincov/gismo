/** @file gsSpaceTimeSolOperNorm.h
    ...
    @brief Computes the space-sime norm induced by the solution operator $L(u) = - u_t + Delta_x u$, i.e.,
    || Delta_x w ||^2_Q + || w_t ||^2_Q
...
/** @brief The gsSpaceTimeSolOperNorm class provides the functionality
 * to calculate the space-sime norm induced by the solution operator.
 *
 * \ingroup Assembler
*/
    template <class T>
