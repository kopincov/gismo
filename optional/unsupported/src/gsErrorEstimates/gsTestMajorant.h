...
namespace gismo {
    ...
    public:
        ...
        void gsGetInitialBasis(short_t, short_t, short_t,
        ...
        void gsRecontructV(int refCount, gsPoissonAssembler<real_t>& poissonAssembler,
        ...
        void gsInitializeBasis(short_t, gsMultiBasis<> &, int);
    ...
    void gsTestMajorant<d>::gsRecontructV(int refCount,
        ...
        poissonAssembler.multiBasis(patches.nPatches()-1).getMapper((dirichlet::strategy) poissonAssembler.options().getInt("DirichletStrategy"),
    ...
    void gsTestMajorant<d>::gsRecontructMajorantBasedOnOptimalFlux(int refCounter,
        ...
        gsPoissonPde<> dualPde(this->patches, * pfreeBC, mpV.piece(patches.nPatches()-1));
    ...
    template<unsigned d>
    void gsTestMajorant<d>::gsInitializeBasis(short_t degree,
    ...
    template<unsigned d>
    void gsTestMajorant<d>::gsGetInitialBasis(short_t vDegree, short_t yDegree, short_t wDegree,
