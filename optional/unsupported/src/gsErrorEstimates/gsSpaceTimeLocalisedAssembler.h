/** @file gsSpaceTimeLocalisedAssembler.h
    ...
    @brief Provides space-time assembler for a homogeneous heat equation that corresponds
    to the locally-stabilised IgA space-time scheme.
...
/** @brief
    Implementation of a space-time assembler for a homogeneous heat equation that corresponds
    to the locally-stabilised IgA space-time scheme.

    It inherits from the gsAssembler
*/
    template <class T>
