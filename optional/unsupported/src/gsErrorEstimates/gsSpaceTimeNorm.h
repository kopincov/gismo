/** @file gsSpaceTimeNorm.h
    ...
    @brief Computes the space-time norm || grad_x w ||^2_Q + h || w_t ||^2_Q.
 ...
 * to calculate the space-time norm $|| grad_x w ||^2_Q + h || w_t ||^2_Q$ between a field and a function.
 *
 * \ingroup Assembler
*/
template <class T>
