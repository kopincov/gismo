/** @file gsErrEstDualSpaceTimeMajorantII.h
    ...
    @brief A class that computes advanced form of the indicator $m^2_d := ||grad v - y||^2_Q, dual part of the
    second form of the majorant.
...
*/
    ...
    public:
        /** \brief THe constructor of the class accepts three fields v, flux, and w
         *
         * @param _field1
         * @param _field2
         * @param _field3
         * @param _rhsFunctParam
         */
        ...
        /** \brief Computes the residual based on 3 fields r(v, flux, w)
         * \f$ \| v_t - w_t + f + div_x y \|^2_Q := \sum_{K \in \Tau_K} \| v_t - w_t + f + div_x y \|^2_{K}\f$, where
         *
    ...
    protected:
        ...
        */
                             ...
                             gsMatrix<T>            & quNodes)
        {
            ...
            flux.eval_into(quNodes, m_fluxVals);
            v.deriv_into(quNodes, m_approxGradV);
            w.deriv_into(quNodes, m_approxGradW);
        }
