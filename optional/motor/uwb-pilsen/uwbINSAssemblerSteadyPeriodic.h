/** @file uwbINSAssemblerSteadyPeriodic.h
...
template<class T>
class uwbINSAssemblerSteadyPeriodic : public uwbINSAssemblerSteady<T>, public uwbINSAssemblerPeriodicCoupledBase<T>
{
...
public:
    ...
    uwbINSAssemblerSteadyPeriodic(uwbINSSolverParams<T>& params) : Base(params), BasePeriodic(params, this->m_blockAssembler)
    {
    }

    virtual ~uwbINSAssemblerSteadyPeriodic()
    {
    }
