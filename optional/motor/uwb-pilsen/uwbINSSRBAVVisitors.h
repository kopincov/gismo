...
// ============================================================= PARENT ============================================================= //
template <class T>
class uwbINSSRBAVVisitor : public uwbINSBlockVisitor<T>
{
...
public:
    uwbINSSRBAVVisitor(std::vector< gsDofMapper > & dofMappers, const T viscosity) :
        ...
        gsMatrix<T>            & quNodes)
    {
        ...
        if (m_bUnsteady)
        {
            GISMO_ASSERT(m_bOldSolSet, "Old time step solution not set in srbav visitor.");
        ...
        GISMO_ASSERT(m_bPSolSet, "Pressure solution not set in srbav visitor.");
