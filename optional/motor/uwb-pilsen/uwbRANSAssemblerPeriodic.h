/** @file uwbRANSAssemblerPeriodic.h

Author(s): H. Hornikova, E. Turnerova
*/

// this class is identical to uwbINSAssemblerUnsteadyPeriodic except the type of Base
// how to do it better?
...
template<class T>
class uwbRANSAssemblerPeriodic : public uwbRANSAssembler<T>, public uwbINSAssemblerPeriodicCoupledBase<T>
{
...
public:
    ...
    uwbRANSAssemblerPeriodic(uwbINSSolverParams<T>& params, uwbTMSolverBase<T>* pTMsolver) :
        Base(params, pTMsolver), BasePeriodic(params, this->m_blockAssembler)
    {
    }

    virtual ~uwbRANSAssemblerPeriodic()
    {
    }
